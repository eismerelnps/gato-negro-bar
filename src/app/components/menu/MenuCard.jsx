...
export const MenuCard = ({ items}) => {
  ...
  return (
    <div className="   animate__animated animate__backInLeft animate__fast duration-400  basis-full  md:basis-2/5  bg-gradient-to-r from-neutral-300 to-white hover:bg-gradient-to-t hover:from-neutral-50  mx-3 p-4 my-2 text-start border  rounded-xl shadow-xl outline-2  ">
