  ...
  return (
    ...
    >
      <div className="flex flex-rows items-center justify-center">
        ...
        <div className="basis-3/5 hover:bg-slate-50 h-auto  text-slate-50 hover:rounded-full hover:text-black p-1">
          <h2
            className={`${francois_one.className} text-center  text-lg `}
          >
            ABIERTO AHORA
          </h2>
          <p
            className={`${quicksand.className} text-center  `}
          >
            Esperamos tu visita
          </p>
        </div>
